...
NSKKプロジェクトへの貢献を歓迎します！このガイドでは、世界最高峰のSKK実装に貢献するための詳細な手順とガイドラインを提供します。コード品質、テスト、ドキュメント、パフォーマンスの全ての面で最高水準を維持するため、明確な基準を設けています。
...
あなたの貢献で、NSKKがさらに多くのユーザーにとって最高の日本語入力環境となることを期待しています。
