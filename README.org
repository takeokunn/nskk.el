...
|------------------+-----------------------------------------|
| Lexical binding  | All 29 source modules use =lexical-binding: t= |
...
#+begin_quote
The project includes =flake.nix= for a convenient Nix development environment.
=nix develop= provides Emacs 29.1+ with the development dependencies used by
the project.
#+end_quote
