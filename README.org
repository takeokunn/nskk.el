...
stateDiagram-v2
    ...
    Conversion --> Conversion: SPC next or x prev
    Conversion --> Conversion: a-l direct select
    Conversion --> ASCII: RET commit newline
    Conversion --> ASCII: C-g cancel
    Conversion --> ASCII: arrow keys commit move
    Conversion --> ASCII: C-a line start
    Conversion --> ASCII: C-e line end
    ...
    Full-width --> ASCII: C-j or l or C-g
    Full-width --> Hiragana: C-j

    Abbrev --> ASCII: C-j or l or C-g
