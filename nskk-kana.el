...
;;
;; Key public API (sync wrappers auto-generated by defun/k / defun/done):
...
;;
;; CPS (/k) variants for pipeline composition (auto-generated by defun/k):
;; - `nskk-kana-han-p/k'
...
Always succeeds."
  (if (stringp string-or-char)
      ;; String path: use CPS bind — tail position forwards result to on-found.
      (<- result nskk-kana--zenkaku-string-to-hankaku string-or-char)
    ;; Character path: direct hash lookup, always succeeds.
    (succeed (let ((str (char-to-string string-or-char)))
